        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Discover and classify sensitive data across your organization, enabling better data governance and
                compliance.
              </motion.p>
              <motion.div
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              transition={{ delay: 0.3, duration: 0.4 }}
              className="rounded-xl p-6 bg-gradient-to-br from-[#0f172a] via-[#10233a] to-[#0b1221] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.5)] relative overflow-hidden min-h-[250px]"
            >
              <div className="absolute inset-0 opacity-30">
                <div className="w-full h-full bg-[radial-gradient(circle,rgba(28,211,92,0.8)_2px,transparent_2px)] [background-size:28px_28px]" />
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-[#1cd35c]/20 via-transparent to-transparent" />
              <motion.div
                animate={{ y: [0, -4, 0] }}
                transition={{ duration: 2.8, repeat: Infinity, ease: "easeInOut" }}
                className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white"
              >
                <Search className="w-9 h-9 mb-3 text-[#1cd35c]" />
                <h2 className="text-3xl font-extrabold tracking-tight">DD&DC</h2>
                <p className="text-lg mt-1.5 text-white/90">Product Preview</p>
              </motion.div>
            </motion.div>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About DD&DC</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                DD&DC scans your data landscape, classifies sensitive information, and provides actionable reports for
                compliance.
              </p>
