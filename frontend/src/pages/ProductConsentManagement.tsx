...
const points = [
  "Customizable consent collection workflows",
  "Real-time consent tracking",
  "Audit logs for compliance",
  "User-friendly consent management portal",
];

const ProductConsentManagement = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            >
              <div className="w-14 h-14 rounded-full bg-[#1cd35c] text-white flex items-center justify-center shadow-[0_0_24px_rgba(28,211,92,0.35)]">
            ...
            <div className="flex-1">
              ...
              >
                Easily manage, track, and document user consents for data processing, supporting compliance and user
                trust.
              </motion.p>
              <motion.div
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#34d399] via-[#14b8a6] to-[#0ea5e9] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              <div className="absolute inset-0 opacity-12">
                <div className="w-full h-full bg-[radial-gradient(circle,rgba(255,255,255,0.8)_2px,transparent_2px)] [background-size:48px_48px]" />
              </div>
              <motion.div
                animate={{ y: [0, -4, 0] }}
              ...
              >
                <CheckCircle2 className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">Consent Management</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About Consent Management</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                Consent Management helps you capture, store, and manage user consents, with customizable workflows and
                audit logs.
              </p>
...
export default ProductConsentManagement;
