...
const points = [
  "Automated DSR intake forms",
  "Request tracking dashboard",
  "Deadline reminders and alerts",
  "Exportable response templates",
];

const ProductDsrRequest = () => {
  return (
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Streamline the management of Data Subject Rights (DSR) requests, ensuring timely and compliant
                responses.
              </motion.p>
              <motion.div
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#c084fc] via-[#ec4899] to-[#ef4444] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              ...
              >
                ...
                <h2 className="text-3xl font-extrabold tracking-tight">DSR Request</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About DSR Request</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                DSR Request module automates intake, tracking, and fulfillment of data subject rights requests,
...
export default ProductDsrRequest;
