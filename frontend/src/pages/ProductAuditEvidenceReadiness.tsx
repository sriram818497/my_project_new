...
const points = [
  ...
  "Audit trail timeline and ownership logs",
  "Export-ready packages for audits and regulators",
];

const ProductAuditEvidenceReadiness = () => {
  return (
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <motion.p
                ...
                className="mt-2.5 text-base md:text-lg leading-relaxed text-white/70 max-w-xl"
              >
                Build defensible proof of compliance with structured evidence capture, control tracking, and audit-ready
                reporting across your privacy and security program.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 8 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.28, duration: 0.35 }}
                className="mt-4 inline-flex items-center rounded-full bg-[#1cd35c]/20 border border-[#1cd35c]/30 px-3 py-0.5 text-xs font-semibold text-[#7bf0a6]"
              >
                Available
              </motion.div>
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#22d3ee] via-[#3b82f6] to-[#6366f1] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              ...
              >
                <ShieldCheck className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">Audit Readiness</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About Audit & Evidence Readiness</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                This module helps legal, privacy, and security teams prepare for internal and external audits with
                consistent evidence, clear accountability, and faster response cycles.
              </p>
...
export default ProductAuditEvidenceReadiness;
