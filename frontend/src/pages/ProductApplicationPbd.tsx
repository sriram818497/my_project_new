...
const points = [
  ...
  "Developer guidance for privacy controls",
  "Automated privacy checks in CI/CD",
  "Documentation for compliance audits",
];

const ProductApplicationPbd = () => {
  return (
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Integrate Privacy by Design principles into your application development lifecycle, ensuring privacy is
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#6366f1] via-[#a855f7] to-[#ec4899] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              <div className="absolute inset-0 opacity-15">
                <div className="w-full h-full bg-[radial-gradient(circle,rgba(255,255,255,0.8)_2px,transparent_2px)] [background-size:28px_28px]" />
              </div>
              <motion.div
                animate={{ y: [0, -4, 0] }}
              ...
              >
                <Network className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">Application PbD</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About Application PbD</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                Application PbD ensures privacy is embedded in every stage of your software development, from design
                to deployment.
              </p>
...
export default ProductApplicationPbd;
