...
const points = [
  ...
  "Data storage and transfer visualization",
  "Risk identification for data flows",
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Visualize and map data flows within your organization to understand where data resides and how it
                moves.
              </motion.p>
              <motion.div
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              transition={{ delay: 0.3, duration: 0.4 }}
              className="rounded-xl p-6 bg-gradient-to-br from-[#14b8a6] via-[#22c55e] to-[#3b82f6] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              ...
              >
                <MapPinned className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">Data Mapping</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About Data Mapping</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                Data Mapping visualizes your data ecosystem, helping you identify data flows, storage locations, and
                transfer risks.
              </p>
