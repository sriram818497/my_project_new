...
const points = [
  "Cookie scanner for website compliance",
  "Automated privacy gap assessments",
  "Consent form generator",
  "Comprehensive compliance reports",
];

const ProductFreeTools = () => {
  return (
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                A suite of free privacy and security assessment tools to help organizations quickly evaluate compliance
                and risk across multiple regulations.
              </motion.p>
              <motion.div
              ...
              >
                ...
                <a
                  href="https://app.protecciodata.com/"
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#60a5fa] via-[#a855f7] to-[#ec4899] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              <div className="absolute inset-0 opacity-16">
                <div className="w-full h-full bg-[radial-gradient(circle,rgba(255,255,255,0.85)_2px,transparent_2px)] [background-size:56px_56px]" />
              </div>
              <motion.div
                animate={{ y: [0, -4, 0] }}
              ...
              >
                <Shield className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">Free Tools</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About Free Tools</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                Our free tools provide instant insights into your privacy posture, including cookie scanning, gap
                assessments, and consent form generation.
              </p>
...
export default ProductFreeTools;
