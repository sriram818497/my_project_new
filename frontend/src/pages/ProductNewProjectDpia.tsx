...
const points = [
  ...
  "Exportable DPIA reports",
];

const ProductNewProjectDpia = () => {
  return (
        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Conduct Data Protection Impact Assessments (DPIA) for new projects, identifying and mitigating privacy
                risks early.
              </motion.p>
              <motion.div
              ...
              >
                ...
                <a
                  href="https://pia.protecciodata.com/"
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#fb923c] via-[#ef4444] to-[#db2777] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              <div className="absolute inset-0 opacity-14">
                <div className="w-full h-full bg-[linear-gradient(90deg,rgba(255,255,255,0.5)_1px,transparent_1px),linear-gradient(180deg,rgba(255,255,255,0.5)_1px,transparent_1px)] [background-size:42px_42px]" />
              </div>
              <motion.div
                animate={{ y: [0, -4, 0] }}
              ...
              >
                <ClipboardCheck className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">New Project DPIA</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About New Project DPIA</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                DPIA module guides you through risk assessments for new projects, providing templates, risk scoring,
...
export default ProductNewProjectDpia;
