        ...
        >
          <div className="flex flex-col md:flex-row gap-5 md:gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              >
                Assess and manage third-party risks to ensure your vendors and partners meet your security and privacy
                standards.
              </motion.p>
              <motion.div
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <motion.div
              ...
              className="rounded-xl p-6 bg-gradient-to-br from-[#22d3ee] via-[#3b82f6] to-[#4f46e5] border border-white/10 shadow-[0_16px_35px_rgba(2,6,23,0.45)] relative overflow-hidden min-h-[250px]"
            >
              ...
              >
                <Scale className="w-9 h-9 mb-3 text-white" />
                <h2 className="text-3xl font-extrabold tracking-tight">TPRM</h2>
            ...
            <motion.div
              ...
              className="py-1"
            >
              <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-white mb-3">About TPRM</h3>
              <p className="text-lg md:text-xl leading-relaxed text-white/70 mb-4">
                TPRM module centralizes third-party risk assessments, automates due diligence, and tracks vendor
                compliance.
              </p>
